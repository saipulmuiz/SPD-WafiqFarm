...
(function($){
    $.fn.extend({
        ...
        if(defaults.type == 'csv' || defaults.type == 'txt'){
            ...
            download('data:text/plain;'+base64data,'SPD_Wafiq-Farm.'+defaults.type,'text/plain');
            ...
            function exportToFile(data,type){
                ...
                hiddenElement.href = 'data:text/'+type+';filename='+'SPD_Wafiq-Farm.'+type+';'+'charset=utf-8,' + encodeURI(data);
                hiddenElement.target = '_blank';
                hiddenElement.download = 'SPD_Wafiq-Farm.'+type;
                hiddenElement.click();
            }
        }
