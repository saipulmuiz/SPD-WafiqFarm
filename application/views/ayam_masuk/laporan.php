<?php $this->load->view('_parts/header')?>
 <!-- PAGE TITLE -->
                ...
                <div class="card-header">
                    <h4><a href="<?php echo site_url('ayam_masuk') ?>"><i class="fa fa-arrow-left"></i> Data Ayam Masuk</a></h4>
                </div>
                <br>
                    ...
                    <div class="row">
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url('ayam_masuk/laporan'); ?>">Reset Filter</a>
