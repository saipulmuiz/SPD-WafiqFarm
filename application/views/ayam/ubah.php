                            ...
                            <div class="panel-body">  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                                                                                                                       
                                        ...
                                        <?php foreach ($suppliers as $supplier): ?>
                                            <option value="<?= $supplier->id_supplier ?>"<?php if($supplier->id_supplier == $ayam->id_supplier) echo 'selected' ?>><?= $supplier->nama ?></option>
                                        <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                            <input type="text" class="form-control spinner_default <?php echo form_error('umur') ? 'is-invalid':'' ?>" name="umur" value="<?= $ayam->umur ?>" required/>
                                        </div>    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        <div class="input-group">
                                            ...
                                            <input type="text" oninput="totalHarga()" class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>" name="harga" value="<?= $ayam->harga ?>" required/>
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-dollar"></span></span>
                                            <input type="text" class="form-control <?php echo form_error('total_harga') ? 'is-invalid':'' ?>" name="total_harga" value="<?= $ayam->total_harga ?>" readonly/>
                                        </div>
                                        <div class="invalid-feedback">
