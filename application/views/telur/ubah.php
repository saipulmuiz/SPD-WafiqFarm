 ...
 <div class="page-content-wrap">
                ...
                <div class="row">
                    ...
                    <?php endif; ?>
                        ...
                        <input type="hidden" name="id" value="<?php echo $telur->id_telur?>" />

                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Ubah</strong> Telur</h3>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="jenis" value="<?= $telur->jenis ?>" required/>
                                        </div>                                  
                                        <span class="help-block">Masukan jenis telur</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                            <input type="text" class="form-control <?php echo form_error('kualitas') ? 'is-invalid':'' ?>" name="kualitas" value="<?= $telur->kualitas ?>" required/>
                                        </div>    
                                        <div class="invalid-feedback">
                                            <?php echo form_error('kualitas') ?>
                                        </div>                                          
                                        <span class="help-block">Masukan kualitas telur</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        ...
                                        <span class="help-block">Masukan jumlah telur</span>
                                    </div>
                                </div>
