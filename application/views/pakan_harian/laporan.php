<?php $this->load->view('_parts/header')?>
 <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Laporan Transaksi Pemberian Pakan</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="card-header">
                    <h4><a href="<?php echo site_url('pakan_harian') ?>"><i class="fa fa-arrow-left"></i> Data Pemberian Pakan</a></h4>
                </div>
                <br>
                    ...
                    <div class="row">
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url('pakan_harian/laporan'); ?>">Reset Filter</a>
