...
<!-- PAGE CONTENT WRAPPER -->
 <div class="page-content-wrap">
                ...
                <div class="row">
                    ...
                    <?php endif; ?>
                        <form id="jvalidate" action="<?php base_url('pakan_masuk/tambah') ?>" method="post" class="form-horizontal">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Tambah</strong> Pakan Masuk</h3>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        ...
                                        <span class="help-block">Masukan stok pakan yang tersedia (Kg)</span>
                                    </div>
                                </div>     
                            </div>               
                    </div> 
    ...
    //         $.ajax({
    //             type : "POST",
    //             url  : "<?php echo base_url('pakan/tambah')?>",
    //             dataType : "JSON",
